...
| ![My-Library-in-Bear](/images/bear-post/library.png){:class="img-responsive"} |
|:--:|
| *My Library in Bear* |
...
| ![nested-tags](/images/bear-post/nestedTags.png){:class="img-responsive"} |
|:--:|
| *Nested tags in Bear* |
...
| ![selected-notes](/images/bear-post/selectedNotes.png){:class="img-responsive"} |
|:--:|
| *Illustration when user selects multiple notes* |

| ![empty-trash](/images/bear-post/empty.png){:class="img-responsive"} |
|:--:|
...
| ![selected-notes](/images/bear-post/tagSystems.png){:class="img-responsive"} |
|:--:|
